...
# check if file exists in directory or download tar file from site
...
# if tar file exists then unpack it. -C is for extract path and if it is successful then will delete the compressed file
